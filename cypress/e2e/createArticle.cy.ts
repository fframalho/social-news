describe('Create Article Test', () => {
    ...
    it('admin user should create article', () => {
        cy.visit('/articles/new-article', {
            onBeforeLoad(win) {
                win.CYPRESS_AUTH_USER = {
                    ...
                    picture:
                        'https://s.gravatar.com/avatar/4c3d30db18c7e79e27be78c175b7c0a6?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fad.png',
        ...
        cy.getByTestId('article-info-title').first().should('contain.text', articleTitle)
    })
})
