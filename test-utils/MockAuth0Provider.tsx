...
const mockGetAccessTokenSilently = ((options?: GetTokenSilentlyOptions & { detailedResponse?: boolean }) => {
...
export const MockAuth0Provider = (user: User) => {
    ...
    return ({ children }: { children: React.ReactNode }) => (
        <div data-testid="mock-auth-provider">
            <Auth0Context.Provider value={mockAuth0Context as Auth0ContextInterface}>{children}</Auth0Context.Provider>
        </div>
    )
}
